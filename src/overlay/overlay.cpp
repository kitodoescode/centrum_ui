...
#include "misc/notifs/notifications.h"
...
#include "misc/keybind/keybind.h"
#include "misc/config/configsystem.h"
...
void render_explorer() {
    ...
    try {
        ...
        */
        ...
        int totalNodes = 0; //nodeCache.size();
...
void render_watermark() {
    ...
    std::string watermark_text = "Skid";
        ...
        */
        ...
        if (FindWindowA(0, "Roblox") && (GetForegroundWindow() == FindWindowA(0, "Roblox") || GetForegroundWindow() == hwnd))
        {
            ...
            if (overlay::visible)
            {
                ...
                ImAdd::Text(style.Colors[ImGuiCol_Text], "Skid");
                ImGui::SameLine();
